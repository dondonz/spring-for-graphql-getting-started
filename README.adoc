...
This guide walks you through the process of creating a GraphQL service in Java using https://docs.spring.io/spring-graphql/docs/current/reference/html/[Spring for GraphQL].
...
== Schema
In your application you initialized earlier, create a directory `src/main/resources/graphql`.
...
// dz todo: fix image link after re-writing the code

You should see a response like this.
image:/img/graphiQL.png[GraphQL response]

We have built a GraphQL service and run our first query! With the help of Spring for GraphQL features, we were able to achieve this with only a few lines of code.
...
== Summary
Congratulations! You have built a GraphQL service with Spring for GraphQL.
